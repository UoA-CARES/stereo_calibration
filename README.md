...
```
roslaunch stereo_calibration live_stereo_calibration.launch
```
...
<launch>
    ...
    <arg name="square_length" default="39.0"/><!--mm-->
    <arg name="image_width"  default="4000"/>
    <arg name="image_height" default="3000"/>
    ...
    <arg name="marker_length" default="20.0"/><!--mm-->
...
<launch>
    <!--File Path-->
    <arg name="image_path"     default="$(env HOME)/calibration_test/charuco/"/>
    <arg name="save_directory" default="$(arg image_path)"/>

    <!--Number of corners-->
    <arg name="board_width"   default="8"/>
    <arg name="board_height"  default="5"/>
    <arg name="square_length" default="39"/><!--mm-->
